...
// const service = new chrome.ServiceBuilder('C:\\Program Files\\chromedriver\\chromedriver.exe');
...
//     driver = await new Builder().setChromeOptions(opts).forBrowser('chrome').setChromeService(service).build();
//     vars = {}
